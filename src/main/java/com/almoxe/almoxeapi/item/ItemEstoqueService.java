...
public class ItemEstoqueService {
    ...
    public ItemEstoqueResponse darEntrada(EntradaRequest request) {
        ...
        Usuario usuario = usuarioRepository.findById(request.usuarioId())
                .orElseThrow(() -> new RecursoNaoEncontradoException("Usuário não encontrado: " + request.usuarioId()));
        ...
        registrarMovimentacao(item, usuario, request.quantidade(), request.observacao());
    ...
    private void registrarMovimentacao(ItemEstoque item, Usuario usuario, BigDecimal quantidade, String observacao) {
